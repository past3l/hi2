...
public final class OnBackPressedDispatcher {
        ...
        if (BuildCompat.isAtLeastT()) {
            this.mEnabledConsumer = new Consumer() { // from class: androidx.activity.OnBackPressedDispatcher$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    OnBackPressedDispatcher.this.m31lambda$new$0$androidxactivityOnBackPressedDispatcher((Boolean) obj);
                }
            };
    ...
    public /* synthetic */ void m31lambda$new$0$androidxactivityOnBackPressedDispatcher(Boolean bool) {
        if (BuildCompat.isAtLeastT()) {
            updateBackInvokedCallbackState();
        }
    }
