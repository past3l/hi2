...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m112m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            super(windowInsetsCompat);
            WindowInsets.Builder m112m;
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                m112m = HalfKt$$ExternalSyntheticApiModelOutline0.m113m(windowInsets);
            } else {
                m112m = HalfKt$$ExternalSyntheticApiModelOutline0.m112m();
            }
            this.mPlatBuilder = m112m;
        }
