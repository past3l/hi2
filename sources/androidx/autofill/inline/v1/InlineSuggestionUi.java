...
public final class InlineSuggestionUi {
    ...
    public static final class Content extends SlicedContent {
        ...
        Content(Slice slice) {
            ...
            while (it.hasNext()) {
                SliceItem m8m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m8m(it.next());
                String itemType = itemType(m8m);
                if (itemType != null) {
                    itemType.hashCode();
                    char c = 65535;
        ...
        */
        private static java.lang.String itemType(android.app.slice.SliceItem r3) {
            /*
                java.lang.String r0 = androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m18m(r3)
                r0.hashCode()
                int r1 = r0.hashCode()
                r2 = -1
                switch(r1) {
            ...
            L34:
                return r0
            L35:
                android.graphics.drawable.Icon r1 = androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m11m(r3)
                if (r1 != 0) goto L3c
                return r0
            L3c:
                java.util.List r1 = androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m21m(r3)
                java.lang.String r2 = "inline_start_icon"
                boolean r1 = r1.contains(r2)
                if (r1 == 0) goto L49
                return r2
            L49:
                java.util.List r3 = androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m21m(r3)
                java.lang.String r1 = "inline_end_icon"
                boolean r3 = r3.contains(r1)
                if (r3 == 0) goto L9b
                return r1
            L56:
                java.lang.CharSequence r1 = androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m17m(r3)
            ...
            L7b:
                ...
                return r1
            L88:
                android.app.PendingIntent r1 = androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m(r3)
                if (r1 == 0) goto L9b
                java.util.List r3 = androidx.activity.ComponentDialog$$ExternalSyntheticApiModelOutline0.m21m(r3)
