...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo141clone = transition.mo141clone();
        mo141clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo141clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo141clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo141clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo141clone = transition.mo141clone();
        sceneChangeSetup(viewGroup, mo141clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo141clone);
    }
