...
public final class PublicSuffixDatabase {
    ...
    private final List<String> findMatchingRule(List<String> domainLabels) {
        ...
        if (str4 != null) {
            return StringsKt.split$default((CharSequence) ("!" + str4), new char[]{FilenameUtils.EXTENSION_SEPARATOR}, false, 0, 6, (Object) null);
        }
        if (str == null && str2 == null) {
            return PREVAILING_RULE;
        }
        if (str == null || (emptyList = StringsKt.split$default((CharSequence) str, new char[]{FilenameUtils.EXTENSION_SEPARATOR}, false, 0, 6, (Object) null)) == null) {
            emptyList = CollectionsKt.emptyList();
        }
        if (str2 == null || (emptyList2 = StringsKt.split$default((CharSequence) str2, new char[]{FilenameUtils.EXTENSION_SEPARATOR}, false, 0, 6, (Object) null)) == null) {
