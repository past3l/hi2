...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2147receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2147receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2148tryReceivePtdJZtk() {
        return this._channel.mo2148tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2149trySendJP2dKIU(E element) {
        return this._channel.mo2149trySendJP2dKIU(element);
    }
