...
public interface SendChannel<E> {
    ...
    Object mo2149trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo2149trySendJP2dKIU = sendChannel.mo2149trySendJP2dKIU(e);
            if (ChannelResult.m2164isSuccessimpl(mo2149trySendJP2dKIU)) {
                return true;
            }
            Throwable m2158exceptionOrNullimpl = ChannelResult.m2158exceptionOrNullimpl(mo2149trySendJP2dKIU);
