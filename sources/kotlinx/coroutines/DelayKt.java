...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2195scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2131delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m2132toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2132toDelayMillisLRDsOJo(long j) {
        if (Duration.m1966compareToLRDsOJo(j, Duration.INSTANCE.m2070getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1985getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
