...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m604constructorimpl = Result.m604constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m604constructorimpl = Result.m604constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m610isFailureimpl(m604constructorimpl) ? null : m604constructorimpl);
        if (bool != null) {
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m2171installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m2171installSignalHandler$lambda1(Signal signal) {
