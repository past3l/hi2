...
public final class InlineList<E> {
    ...
    public static final /* synthetic */ InlineList m2183boximpl(Object obj) {
        return new InlineList(obj);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <E> Object m2184constructorimpl(Object obj) {
        return obj;
    }
    ...
    public static int m2189hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public static String m2191toStringimpl(Object obj) {
    ...
    public int hashCode() {
        return m2189hashCodeimpl(this.holder);
    }

    public String toString() {
        return m2191toStringimpl(this.holder);
    }
    ...
    public static /* synthetic */ Object m2185constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
        return m2184constructorimpl(obj);
    }

    /* renamed from: plus-FjFbRPM, reason: not valid java name */
    public static final Object m2190plusFjFbRPM(Object obj, E e) {
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(e instanceof List))) {
            throw new AssertionError();
        }
        if (obj == null) {
            return m2184constructorimpl(e);
        }
        ...
        arrayList.add(obj);
        arrayList.add(e);
        return m2184constructorimpl(arrayList);
    }

    /* renamed from: forEachReversed-impl, reason: not valid java name */
    public static final void m2188forEachReversedimpl(Object obj, Function1<? super E, Unit> function1) {
        if (obj == null) {
            return;
        }
        if (!(obj instanceof ArrayList)) {
