...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo2195scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo2195scheduleResumeAfterDelay(timeMillis, continuation);
    }
    ...
    */
    ...
    public void mo2194dispatch(CoroutineContext context, Runnable block) {
        ...
        this.dispatcher.mo2194dispatch(this, this);
    }
