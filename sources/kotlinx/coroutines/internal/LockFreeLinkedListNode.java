...
public class LockFreeLinkedListNode {
    ...
    public final LockFreeLinkedListNode removeFirstOrNull() {
        while (true) {
            ...
            if (lockFreeLinkedListNode.mo2193remove()) {
        ...
        public Object perform(Object affected) {
            ...
            if (affected != null) {
                ...
                if (obj == AtomicKt.NO_DECISION) {
                    ...
                    updatedNext = obj == null ? this.desc.updatedNext(lockFreeLinkedListNode, this.next) : this.next;
                }
