...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo1958minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2104minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo1957elapsedNowUwyO8pc() {
        return Duration.m2002minusLRDsOJo(this.mark.mo1957elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1960plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m2003plusLRDsOJo(this.adjustment, duration), null);
    }
}
