...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m2107boximpl(m2101markNowz9LOYto());
    }
    ...
    public long m2101markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m2110constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m2100elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m2099differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m2098adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m2110constructorimpl(LongSaturatedMathKt.m2096saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
