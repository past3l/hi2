...
public interface TimeMark {
    ...
    TimeMark mo1958minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1960plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m2105plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2104minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1960plusLRDsOJo(Duration.m2020unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m2000isNegativeimpl(timeMark.mo1957elapsedNowUwyO8pc());
        }
