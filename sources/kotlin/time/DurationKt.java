...
public final class DurationKt {
    ...
    private static final long m2094timesmvk6XK0(int i, long j) {
        return Duration.m2005timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m2093timeskIfJnKk(double d, long j) {
        return Duration.m2004timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long m2070getZEROUwyO8pc = Duration.INSTANCE.m2070getZEROUwyO8pc();
        ...
        if (str2.charAt(i) == 'P') {
            ...
            while (i2 < length) {
                if (str2.charAt(i2) != 'T') {
                    ...
                    int indexOf$default = StringsKt.indexOf$default((CharSequence) str3, FilenameUtils.EXTENSION_SEPARATOR, 0, false, 6, (Object) null);
                    if (durationUnitByIsoChar == DurationUnit.SECONDS && indexOf$default > 0) {
                        Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                        String substring2 = substring.substring(0, indexOf$default);
                        Intrinsics.checkNotNullExpressionValue(substring2, "substring(...)");
                        z4 = z8;
                        long m2003plusLRDsOJo = Duration.m2003plusLRDsOJo(m2070getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                        Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                        String substring3 = substring.substring(indexOf$default);
                        Intrinsics.checkNotNullExpressionValue(substring3, "substring(...)");
                        m2070getZEROUwyO8pc = Duration.m2003plusLRDsOJo(m2003plusLRDsOJo, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                    } else {
                        z4 = z8;
                        m2070getZEROUwyO8pc = Duration.m2003plusLRDsOJo(m2070getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                    }
                    z8 = z4;
            ...
            if (StringsKt.regionMatches(str, i, "Infinity", 0, Math.max(length - i, 8), true)) {
                m2070getZEROUwyO8pc = Duration.INSTANCE.m2068getINFINITEUwyO8pc();
            } else {
                boolean z9 = !z6;
                ...
                while (i < length) {
                    ...
                    String str7 = str5;
                    int indexOf$default2 = StringsKt.indexOf$default((CharSequence) str6, FilenameUtils.EXTENSION_SEPARATOR, 0, false, 6, (Object) null);
                    if (indexOf$default2 > 0) {
                        ...
                        long m2003plusLRDsOJo2 = Duration.m2003plusLRDsOJo(m2070getZEROUwyO8pc, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                        Intrinsics.checkNotNull(substring4, "null cannot be cast to non-null type java.lang.String");
                        String substring7 = substring4.substring(indexOf$default2);
                        Intrinsics.checkNotNullExpressionValue(substring7, "substring(...)");
                        m2070getZEROUwyO8pc = Duration.m2003plusLRDsOJo(m2003plusLRDsOJo2, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                        if (i < length) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        m2070getZEROUwyO8pc = Duration.m2003plusLRDsOJo(m2070getZEROUwyO8pc, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                    }
                    str2 = str;
                    str5 = str7;
        ...
        return z2 ? Duration.m2020unaryMinusUwyO8pc(m2070getZEROUwyO8pc) : m2070getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1967constructorimpl(j << 1);
    }

    public static final long durationOfMillis(long j) {
        return Duration.m1967constructorimpl((j << 1) + 1);
    }

    public static final long durationOf(long j, int i) {
        return Duration.m1967constructorimpl((j << 1) + i);
    }
