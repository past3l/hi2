...
public final class UInt implements Comparable<UInt> {
    ...
    public boolean equals(Object obj) {
        return m706equalsimpl(this.data, obj);
    }
    ...
    private static final int m695compareTo7apg3OU(int i, byte b) {
        int compare;
        compare = Integer.compare(i ^ Integer.MIN_VALUE, m700constructorimpl(b & UByte.MAX_VALUE) ^ Integer.MIN_VALUE);
        return compare;
    }
    ...
    private static final int m699compareToxj2QHRw(int i, short s) {
        int compare;
        compare = Integer.compare(i ^ Integer.MIN_VALUE, m700constructorimpl(s & UShort.MAX_VALUE) ^ Integer.MIN_VALUE);
        return compare;
    }
    ...
    private static final int m696compareToVKZWuLQ(int i, long j) {
        int compare;
        compare = Long.compare(ULong.m779constructorimpl(i & 4294967295L) ^ Long.MIN_VALUE, j ^ Long.MIN_VALUE);
        return compare;
    }

    /* renamed from: plus-7apg3OU, reason: not valid java name */
    private static final int m724plus7apg3OU(int i, byte b) {
        return m700constructorimpl(i + m700constructorimpl(b & UByte.MAX_VALUE));
    }
    ...
    private static final long m725plusVKZWuLQ(int i, long j) {
        return ULong.m779constructorimpl(ULong.m779constructorimpl(i & 4294967295L) + j);
    }
    ...
    private static final int m702div7apg3OU(int i, byte b) {
        return UByte$$ExternalSyntheticBackport0.m$1(i, m700constructorimpl(b & UByte.MAX_VALUE));
    }
    ...
    private static final long m703divVKZWuLQ(int i, long j) {
        return UByte$$ExternalSyntheticBackport0.m$1(ULong.m779constructorimpl(i & 4294967295L), j);
    }

    /* renamed from: rem-7apg3OU, reason: not valid java name */
    private static final int m730rem7apg3OU(int i, byte b) {
        return UByte$$ExternalSyntheticBackport0.m(i, m700constructorimpl(b & UByte.MAX_VALUE));
    }
    ...
    private static final long m731remVKZWuLQ(int i, long j) {
        return UByte$$ExternalSyntheticBackport0.m673m(ULong.m779constructorimpl(i & 4294967295L), j);
    }
    ...
    private static final byte m719mod7apg3OU(int i, byte b) {
        return UByte.m622constructorimpl((byte) UByte$$ExternalSyntheticBackport0.m(i, m700constructorimpl(b & UByte.MAX_VALUE)));
    }

    /* renamed from: mod-xj2QHRw, reason: not valid java name */
    private static final short m722modxj2QHRw(int i, short s) {
        return UShort.m886constructorimpl((short) UByte$$ExternalSyntheticBackport0.m(i, m700constructorimpl(s & UShort.MAX_VALUE)));
    }
    ...
    private static final UIntRange m729rangeUntilWZ4Q5Ns(int i, int i2) {
        return URangesKt.m1894untilJ1ME1BU(i, i2);
    }
    ...
    private static final byte m747toUBytew2LRezQ(int i) {
        return UByte.m622constructorimpl((byte) i);
    }
    ...
    private static final long m749toULongsVKNKU(int i) {
        return ULong.m779constructorimpl(i & 4294967295L);
    }
