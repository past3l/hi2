...
public final class UStringsKt {
    ...
    public static final String m1954toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1956toStringolVBNx4(short s, int i) {
    ...
    public static final String m1955toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1953toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m700constructorimpl(255) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UByte.m616boximpl(UByte.m622constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m700constructorimpl(65535) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UShort.m880boximpl(UShort.m886constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int m700constructorimpl = UInt.m700constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            if (compare > 0) {
                if (i4 == 119304647) {
                    i4 = UByte$$ExternalSyntheticBackport0.m$1(-1, m700constructorimpl);
            ...
            int m700constructorimpl2 = UInt.m700constructorimpl(i3 * m700constructorimpl);
            int m700constructorimpl3 = UInt.m700constructorimpl(UInt.m700constructorimpl(digitOf) + m700constructorimpl2);
            compare2 = Integer.compare(m700constructorimpl3 ^ Integer.MIN_VALUE, m700constructorimpl2 ^ Integer.MIN_VALUE);
            if (compare2 < 0) {
                return null;
            }
            i2++;
            i3 = m700constructorimpl3;
        }
        return UInt.m694boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long m779constructorimpl = ULong.m779constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (compare > 0) {
                if (j2 == 512409557603043100L) {
                    j2 = UByte$$ExternalSyntheticBackport0.m$1(-1L, m779constructorimpl);
            ...
            long m779constructorimpl2 = ULong.m779constructorimpl(j * m779constructorimpl);
            long m779constructorimpl3 = ULong.m779constructorimpl(ULong.m779constructorimpl(UInt.m700constructorimpl(r13) & 4294967295L) + m779constructorimpl2);
            compare2 = Long.compare(m779constructorimpl3 ^ Long.MIN_VALUE, m779constructorimpl2 ^ Long.MIN_VALUE);
            if (compare2 < 0) {
                return null;
            }
            i2++;
            j = m779constructorimpl3;
        }
        return ULong.m773boximpl(j);
    }
}
