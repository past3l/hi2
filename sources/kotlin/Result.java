...
public final class Result<T> implements Serializable {
    ...
    public static final /* synthetic */ Result m603boximpl(Object obj) {
    ...
    public static int m609hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public int hashCode() {
        return m609hashCodeimpl(this.value);
    }
    ...
    public static final boolean m611isSuccessimpl(Object obj) {
        return !(obj instanceof Failure);
    }

    /* renamed from: isFailure-impl, reason: not valid java name */
    public static final boolean m610isFailureimpl(Object obj) {
        return obj instanceof Failure;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getOrNull-impl, reason: not valid java name */
    private static final T m608getOrNullimpl(Object obj) {
        if (m610isFailureimpl(obj)) {
            return null;
        }
        return obj;
    }
    ...
    public static String m612toStringimpl(Object obj) {
        if (obj instanceof Failure) {
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T value) {
            return Result.m604constructorimpl(value);
        }

        private final <T> Object failure(Throwable exception) {
            Intrinsics.checkNotNullParameter(exception, "exception");
            return Result.m604constructorimpl(ResultKt.createFailure(exception));
        }
    }
