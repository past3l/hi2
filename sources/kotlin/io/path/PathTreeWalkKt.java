...
public final class PathTreeWalkKt {
    ...
    public static final Object keyOf(Path path, LinkOption[] linkOptionArr) {
        ...
        try {
            ...
            readAttributes = Files.readAttributes(path, (Class<BasicFileAttributes>) Headers$$ExternalSyntheticApiModelOutline0.m(), (LinkOption[]) Arrays.copyOf(linkOptionArr2, linkOptionArr2.length));
