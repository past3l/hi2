...
public class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
        ...
        if ((i & 2) != 0) {
            function3 = new Function3() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$copyToRecursively$1
                ...
                public /* bridge */ /* synthetic */ Object invoke(Object obj2, Object obj3, Object obj4) {
                    return invoke(LinkFollowing$$ExternalSyntheticApiModelOutline0.m1826m(obj2), LinkFollowing$$ExternalSyntheticApiModelOutline0.m1826m(obj3), (Exception) obj4);
                }
        ...
        if (z2) {
            return PathsKt.copyToRecursively(path, target, onError, z, new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$copyToRecursively$2
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path2, Path path3) {
                    return invoke2(copyActionContext, LinkFollowing$$ExternalSyntheticApiModelOutline0.m1826m((Object) path2), LinkFollowing$$ExternalSyntheticApiModelOutline0.m1826m((Object) path3));
                }
        ...
        if ((i & 8) != 0) {
            function32 = new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$copyToRecursively$4
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path3, Path path4) {
                    return invoke2(copyActionContext, LinkFollowing$$ExternalSyntheticApiModelOutline0.m1826m((Object) path3), LinkFollowing$$ExternalSyntheticApiModelOutline0.m1826m((Object) path4));
                }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x00af, code lost:
        ...
        kotlin.io.path.LinkFollowing$$ExternalSyntheticApiModelOutline0.m1835m$2();
     */
    /* JADX WARN: Code restructure failed: missing block: B:22:0x00c0, code lost:
    
        throw okhttp3.Headers$$ExternalSyntheticApiModelOutline0.m(r6.toString(), r7.toString(), "Recursively copying a directory into its subdirectory is prohibited.");
     */
    ...
    */
    public static final java.nio.file.Path copyToRecursively(final java.nio.file.Path r6, final java.nio.file.Path r7, final kotlin.jvm.functions.Function3<? super java.nio.file.Path, ? super java.nio.file.Path, ? super java.lang.Exception, ? extends kotlin.io.path.OnErrorResult> r8, boolean r9, final kotlin.jvm.functions.Function3<? super kotlin.io.path.CopyActionContext, ? super java.nio.file.Path, ? super java.nio.file.Path, ? extends kotlin.io.path.CopyActionResult> r10) {
        /*
            ...
            java.lang.Object[] r0 = java.util.Arrays.copyOf(r0, r1)
            java.nio.file.LinkOption[] r0 = (java.nio.file.LinkOption[]) r0
            boolean r0 = okhttp3.Headers$$ExternalSyntheticApiModelOutline0.m2283m(r6, r0)
            if (r0 == 0) goto Ld2
            r0 = 0
            java.nio.file.LinkOption[] r1 = new java.nio.file.LinkOption[r0]
            java.lang.Object[] r1 = java.util.Arrays.copyOf(r1, r0)
            java.nio.file.LinkOption[] r1 = (java.nio.file.LinkOption[]) r1
            boolean r1 = okhttp3.Headers$$ExternalSyntheticApiModelOutline0.m2283m(r6, r1)
            if (r1 == 0) goto Lc1
            if (r9 != 0) goto L45
            boolean r1 = okhttp3.Headers$$ExternalSyntheticApiModelOutline0.m2281m(r6)
            if (r1 != 0) goto Lc1
        L45:
            java.nio.file.LinkOption[] r1 = new java.nio.file.LinkOption[r0]
            java.lang.Object[] r1 = java.util.Arrays.copyOf(r1, r0)
            java.nio.file.LinkOption[] r1 = (java.nio.file.LinkOption[]) r1
            boolean r1 = okhttp3.Headers$$ExternalSyntheticApiModelOutline0.m2283m(r7, r1)
            if (r1 == 0) goto L5b
            boolean r1 = okhttp3.Headers$$ExternalSyntheticApiModelOutline0.m2281m(r7)
            if (r1 != 0) goto L5b
            r1 = 1
            goto L5c
        L5b:
        ...
        L5c:
            if (r1 == 0) goto L64
            boolean r2 = okhttp3.Headers$$ExternalSyntheticApiModelOutline0.m2282m(r6, r7)
            if (r2 != 0) goto Lc1
        L64:
            java.nio.file.FileSystem r2 = kotlin.io.path.LinkFollowing$$ExternalSyntheticApiModelOutline0.m(r6)
            java.nio.file.FileSystem r3 = kotlin.io.path.LinkFollowing$$ExternalSyntheticApiModelOutline0.m(r7)
        ...
        L73:
            if (r1 == 0) goto L88
            java.nio.file.LinkOption[] r1 = new java.nio.file.LinkOption[r0]
            java.nio.file.Path r1 = okhttp3.Headers$$ExternalSyntheticApiModelOutline0.m(r7, r1)
            java.nio.file.LinkOption[] r0 = new java.nio.file.LinkOption[r0]
            java.nio.file.Path r0 = okhttp3.Headers$$ExternalSyntheticApiModelOutline0.m(r6, r0)
            boolean r0 = okhttp3.Headers$$ExternalSyntheticApiModelOutline0.m$1(r1, r0)
            if (r0 != 0) goto Laf
            goto Lc1
        L88:
            java.nio.file.Path r1 = kotlin.io.path.LinkFollowing$$ExternalSyntheticApiModelOutline0.m$1(r7)
            if (r1 == 0) goto Lc1
            ...
            boolean r2 = okhttp3.Headers$$ExternalSyntheticApiModelOutline0.m2283m(r1, r2)
            if (r2 == 0) goto Lc1
            java.nio.file.LinkOption[] r2 = new java.nio.file.LinkOption[r0]
            java.nio.file.Path r1 = okhttp3.Headers$$ExternalSyntheticApiModelOutline0.m(r1, r2)
            java.nio.file.LinkOption[] r0 = new java.nio.file.LinkOption[r0]
            java.nio.file.Path r0 = okhttp3.Headers$$ExternalSyntheticApiModelOutline0.m(r6, r0)
            boolean r0 = okhttp3.Headers$$ExternalSyntheticApiModelOutline0.m$1(r1, r0)
            if (r0 != 0) goto Laf
        ...
        Laf:
            ...
            java.nio.file.FileSystemException r6 = okhttp3.Headers$$ExternalSyntheticApiModelOutline0.m(r6, r7, r8)
            throw r6
        Lc1:
            r1 = 0
            ...
            return r7
        Ld2:
            okhttp3.Headers$$ExternalSyntheticApiModelOutline0.m2290m$1()
            java.lang.String r6 = r6.toString()
            java.lang.String r7 = r7.toString()
            java.lang.String r8 = "The source file doesn't exist."
            java.nio.file.NoSuchFileException r6 = okhttp3.Headers$$ExternalSyntheticApiModelOutline0.m2262m(r6, r7, r8)
            throw r6
        */
    ...
    public static final void deleteRecursively(Path path) {
        ...
        if (!deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt.isEmpty()) {
            FileSystemException m = LinkFollowing$$ExternalSyntheticApiModelOutline0.m("Failed to delete one or more files. See suppressed exceptions for details.");
    ...
    */
    private static final java.util.List<java.lang.Exception> deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(java.nio.file.Path r8) {
        /*
            ...
            r3 = 0
            r0.<init>(r1, r2, r3)
            java.nio.file.Path r4 = kotlin.io.path.LinkFollowing$$ExternalSyntheticApiModelOutline0.m$1(r8)
            if (r4 == 0) goto L46
            java.nio.file.DirectoryStream r5 = okhttp3.Headers$$ExternalSyntheticApiModelOutline0.m2259m(r4)     // Catch: java.lang.Throwable -> L13
            goto L14
        L13:
            r5 = r3
        L14:
            ...
            java.nio.file.DirectoryStream r6 = okhttp3.Headers$$ExternalSyntheticApiModelOutline0.m(r5)     // Catch: java.lang.Throwable -> L3f
            boolean r7 = okhttp3.Headers$$ExternalSyntheticApiModelOutline0.m2280m(r6)     // Catch: java.lang.Throwable -> L3f
            if (r7 == 0) goto L36
            r0.setPath(r4)     // Catch: java.lang.Throwable -> L3f
            java.nio.file.SecureDirectoryStream r2 = okhttp3.Headers$$ExternalSyntheticApiModelOutline0.m2265m(r6)     // Catch: java.lang.Throwable -> L3f
            java.nio.file.Path r4 = kotlin.io.path.LinkFollowing$$ExternalSyntheticApiModelOutline0.m1827m(r8)     // Catch: java.lang.Throwable -> L3f
            ...
            handleEntry$PathsKt__PathRecursiveFunctionsKt(r2, r4, r0)     // Catch: java.lang.Throwable -> L3f
            goto L37
        L36:
            r1 = r2
        L37:
    ...
    private static final void enterDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, ExceptionsCollector exceptionsCollector) {
        ...
        try {
            SecureDirectoryStream m2265m = Headers$$ExternalSyntheticApiModelOutline0.m2265m((Object) secureDirectoryStream3);
            it = m2265m.iterator();
            while (it.hasNext()) {
                fileName = LinkFollowing$$ExternalSyntheticApiModelOutline0.m1826m(it.next()).getFileName();
                Intrinsics.checkNotNullExpressionValue(fileName, "getFileName(...)");
                handleEntry$PathsKt__PathRecursiveFunctionsKt(m2265m, fileName, exceptionsCollector);
            }
            Unit unit = Unit.INSTANCE;
    ...
    private static final boolean isDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, LinkOption... linkOptionArr) {
        ...
        boolean isDirectory;
        try {
            fileAttributeView = secureDirectoryStream.getFileAttributeView(path, Headers$$ExternalSyntheticApiModelOutline0.m$1(), (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
            readAttributes = Headers$$ExternalSyntheticApiModelOutline0.m2268m((Object) fileAttributeView).readAttributes();
    ...
    private static final void insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(Path path, ExceptionsCollector exceptionsCollector) {
        ...
        try {
            it = Headers$$ExternalSyntheticApiModelOutline0.m((Object) directoryStream2).iterator();
            while (it.hasNext()) {
                Path m1826m = LinkFollowing$$ExternalSyntheticApiModelOutline0.m1826m(it.next());
                Intrinsics.checkNotNull(m1826m);
                insecureHandleEntry$PathsKt__PathRecursiveFunctionsKt(m1826m, exceptionsCollector);
            }
            Unit unit = Unit.INSTANCE;
