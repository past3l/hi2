...
final class FileVisitorImpl extends SimpleFileVisitor<Path> {
    ...
    public /* bridge */ /* synthetic */ FileVisitResult postVisitDirectory(Object obj, IOException iOException) {
        return postVisitDirectory(LinkFollowing$$ExternalSyntheticApiModelOutline0.m1826m(obj), iOException);
    }

    @Override // java.nio.file.SimpleFileVisitor, java.nio.file.FileVisitor
    public /* bridge */ /* synthetic */ FileVisitResult preVisitDirectory(Object obj, BasicFileAttributes basicFileAttributes) {
        return preVisitDirectory(LinkFollowing$$ExternalSyntheticApiModelOutline0.m1826m(obj), basicFileAttributes);
    }

    @Override // java.nio.file.SimpleFileVisitor, java.nio.file.FileVisitor
    public /* bridge */ /* synthetic */ FileVisitResult visitFile(Object obj, BasicFileAttributes basicFileAttributes) {
        return visitFile(LinkFollowing$$ExternalSyntheticApiModelOutline0.m1826m(obj), basicFileAttributes);
    }

    @Override // java.nio.file.SimpleFileVisitor, java.nio.file.FileVisitor
    public /* bridge */ /* synthetic */ FileVisitResult visitFileFailed(Object obj, IOException iOException) {
        return visitFileFailed(LinkFollowing$$ExternalSyntheticApiModelOutline0.m1826m(obj), iOException);
    }
    ...
    public FileVisitResult preVisitDirectory(Path dir, BasicFileAttributes attrs) {
        FileVisitResult m1823m;
        Intrinsics.checkNotNullParameter(dir, "dir");
        Intrinsics.checkNotNullParameter(attrs, "attrs");
        Function2<Path, BasicFileAttributes, FileVisitResult> function2 = this.onPreVisitDirectory;
        if (function2 != null && (m1823m = LinkFollowing$$ExternalSyntheticApiModelOutline0.m1823m((Object) function2.invoke(dir, attrs))) != null) {
            return m1823m;
        }
    ...
    public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) {
        ...
        if (function2 != null && (m1823m = LinkFollowing$$ExternalSyntheticApiModelOutline0.m1823m((Object) function2.invoke(file, attrs))) != null) {
            return m1823m;
        }
    ...
    public FileVisitResult visitFileFailed(Path file, IOException exc) {
        ...
        if (function2 != null && (m1823m = LinkFollowing$$ExternalSyntheticApiModelOutline0.m1823m((Object) function2.invoke(file, exc))) != null) {
            return m1823m;
        }
    ...
    public FileVisitResult postVisitDirectory(Path dir, IOException exc) {
        ...
        if (function2 != null && (m1823m = LinkFollowing$$ExternalSyntheticApiModelOutline0.m1823m((Object) function2.invoke(dir, exc))) != null) {
            return m1823m;
        }
