        ...
        public Data() {
            ...
            this.supertypes = ReflectProperties.lazySoft(new Function0<List<? extends KTypeImpl>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2
                ...
                public final List<? extends KTypeImpl> invoke() {
                    Collection<KotlinType> mo1907getSupertypes = this.this$0.getDescriptor().getTypeConstructor().mo1907getSupertypes();
                    Intrinsics.checkNotNullExpressionValue(mo1907getSupertypes, "getSupertypes(...)");
                    ArrayList arrayList = new ArrayList(mo1907getSupertypes.size());
                    final KClassImpl<T>.Data data = this.this$0;
                    final KClassImpl<T> kClassImpl = r2;
                    for (final KotlinType kotlinType : mo1907getSupertypes) {
                        ...
                        arrayList.add(new KTypeImpl(kotlinType, new Function0<Type>() { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2$1$1
                            ...
                            public final Type invoke() {
                                ClassifierDescriptor mo1906getDeclarationDescriptor = KotlinType.this.getConstructor().mo1906getDeclarationDescriptor();
                                if (!(mo1906getDeclarationDescriptor instanceof ClassDescriptor)) {
                                    throw new KotlinReflectionInternalError("Supertype not a class: " + mo1906getDeclarationDescriptor);
                                }
                                Class<?> javaClass = UtilKt.toJavaClass((ClassDescriptor) mo1906getDeclarationDescriptor);
                                if (javaClass == null) {
                                    throw new KotlinReflectionInternalError("Unsupported superclass of " + data + ": " + mo1906getDeclarationDescriptor);
                                }
                                ...
                                if (indexOf < 0) {
                                    throw new KotlinReflectionInternalError("No superclass of " + data + " in Java reflection for " + mo1906getDeclarationDescriptor);
                                }
