...
public final class ValueClassAwareCallerKt {
    ...
    private static final List<String> getMfvcUnboxMethods$getUnboxMethodNameSuffixes(SimpleType simpleType) {
        ...
        ClassifierDescriptor mo1906getDeclarationDescriptor = simpleType.getConstructor().mo1906getDeclarationDescriptor();
        ...
        MultiFieldValueClassRepresentation<SimpleType> multiFieldValueClassRepresentation = DescriptorUtilsKt.getMultiFieldValueClassRepresentation((ClassDescriptor) mo1906getDeclarationDescriptor);
    ...
    public static final List<Method> getMfvcUnboxMethods(SimpleType type) {
        ...
        ClassifierDescriptor mo1906getDeclarationDescriptor = type.getConstructor().mo1906getDeclarationDescriptor();
        Intrinsics.checkNotNull(mo1906getDeclarationDescriptor, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ClassDescriptor");
    ...
    public static final Class<?> toInlineClass(KotlinType kotlinType) {
        Class<?> inlineClass = toInlineClass(kotlinType.getConstructor().mo1906getDeclarationDescriptor());
        if (inlineClass == null) {
            return null;
        }
