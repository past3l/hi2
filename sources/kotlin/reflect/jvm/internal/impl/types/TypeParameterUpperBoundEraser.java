...
public final class TypeParameterUpperBoundEraser {
    ...
    private final Set<KotlinType> substituteErasedUpperBounds(TypeSubstitutor typeSubstitutor, List<? extends KotlinType> list, ErasureTypeAttributes erasureTypeAttributes) {
        ...
        for (KotlinType kotlinType : list) {
            ...
            } else if (mo1906getDeclarationDescriptor instanceof TypeParameterDescriptor) {
                Set<TypeParameterDescriptor> visitedTypeParameters = erasureTypeAttributes.getVisitedTypeParameters();
                if (visitedTypeParameters != null && visitedTypeParameters.contains(mo1906getDeclarationDescriptor)) {
                    createSetBuilder.add(getDefaultType(erasureTypeAttributes));
                } else {
                    List<KotlinType> upperBounds = ((TypeParameterDescriptor) mo1906getDeclarationDescriptor).getUpperBounds();
                    Intrinsics.checkNotNullExpressionValue(upperBounds, "getUpperBounds(...)");
                ...
                if (!lowerBound.getConstructor().getParameters().isEmpty() && lowerBound.getConstructor().mo1906getDeclarationDescriptor() != null) {
                    ...
                    for (TypeParameterDescriptor typeParameterDescriptor : list) {
                        ...
                        if (starProjectionImpl != null && !z2) {
                            ...
                            if (substitution.mo1911get(type4) != null) {
                                arrayList.add(starProjectionImpl);
                            }
                        }
                ...
                if (!upperBound.getConstructor().getParameters().isEmpty() && upperBound.getConstructor().mo1906getDeclarationDescriptor() != null) {
                    ...
                    for (TypeParameterDescriptor typeParameterDescriptor2 : list2) {
                        ...
                        if (starProjectionImpl2 != null && !z3) {
                            ...
                            if (substitution2.mo1911get(type5) != null) {
                                arrayList2.add(starProjectionImpl2);
                            }
                        }
                ...
                if (!simpleType2.getConstructor().getParameters().isEmpty() && simpleType2.getConstructor().mo1906getDeclarationDescriptor() != null) {
                    ...
                    for (TypeParameterDescriptor typeParameterDescriptor3 : list3) {
                        ...
                        if (starProjectionImpl3 != null && !z4) {
                            ...
                            if (substitution3.mo1911get(type6) != null) {
                                arrayList3.add(starProjectionImpl3);
                            }
                        }
