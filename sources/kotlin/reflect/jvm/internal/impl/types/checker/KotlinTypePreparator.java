    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> mo1907getSupertypes = capturedTypeConstructorImpl.mo1907getSupertypes();
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> mo1907getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo1907getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo1907getSupertypes2, 10));
            Iterator<T> it2 = mo1907getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> mo1907getSupertypes3 = intersectionTypeConstructor2.mo1907getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo1907getSupertypes3, 10));
        Iterator<T> it3 = mo1907getSupertypes3.iterator();
        while (it3.hasNext()) {
