        ...
        while (!supertypesDeque.isEmpty()) {
            ...
            if (supertypesSet.add(pop)) {
                ...
                if (lowerIfFlexible == null) {
                    ...
                    while (it.hasNext()) {
                        SimpleTypeMarker mo1910transformType = lowerIfFlexible.mo1910transformType(typeCheckerState, it.next());
                        if (typeSystemContext.isNothingConstructor(typeSystemContext.typeConstructor(mo1910transformType))) {
        ...
        while (!supertypesDeque.isEmpty()) {
            ...
            if (supertypesSet.add(pop)) {
                ...
                if (substitutionSupertypePolicy != null) {
                    ...
                    Iterator<KotlinTypeMarker> it = typeSystemContext2.supertypes(typeSystemContext2.typeConstructor(pop)).iterator();
                    while (it.hasNext()) {
                        supertypesDeque.add(substitutionSupertypePolicy.mo1910transformType(typeCheckerState, it.next()));
                    }
                }
            }
        }
        ...
        while (!supertypesDeque.isEmpty()) {
            ...
            if (supertypesSet.add(pop)) {
                ...
                if (lowerIfFlexible != null) {
                    ...
                    Iterator<KotlinTypeMarker> it = typeSystemContext2.supertypes(typeSystemContext2.typeConstructor(pop)).iterator();
                    while (it.hasNext()) {
                        supertypesDeque.add(lowerIfFlexible.mo1910transformType(state, it.next()));
                    }
                }
            }
        }
