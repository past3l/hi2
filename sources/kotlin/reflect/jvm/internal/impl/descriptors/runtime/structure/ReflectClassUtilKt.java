...
public final class ReflectClassUtilKt {
    ...
    public static final String getDesc(Class<?> cls) {
        ...
        if (cls.isArray()) {
            ...
            return StringsKt.replace$default(name2, FilenameUtils.EXTENSION_SEPARATOR, IOUtils.DIR_SEPARATOR_UNIX, false, 4, (Object) null);
        }
        StringBuilder sb = new StringBuilder("L");
        String name3 = cls.getName();
        Intrinsics.checkNotNullExpressionValue(name3, "getName(...)");
        sb.append(StringsKt.replace$default(name3, FilenameUtils.EXTENSION_SEPARATOR, IOUtils.DIR_SEPARATOR_UNIX, false, 4, (Object) null));
        sb.append(';');
        return sb.toString();
    }
