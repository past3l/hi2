...
public final class FunctionTypesKt {
    public static final FunctionTypeKind getFunctionTypeKind(KotlinType kotlinType) {
        ...
        if (mo1906getDeclarationDescriptor != null) {
            return getFunctionTypeKind(mo1906getDeclarationDescriptor);
        }
        return null;
    }
    ...
    public static final boolean isBuiltinFunctionalType(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor mo1906getDeclarationDescriptor = kotlinType.getConstructor().mo1906getDeclarationDescriptor();
        return mo1906getDeclarationDescriptor != null && isBuiltinFunctionalClassDescriptor(mo1906getDeclarationDescriptor);
    }
    ...
    private static final boolean isTypeAnnotatedWithExtensionFunctionType(KotlinType kotlinType) {
        return kotlinType.getAnnotations().mo1901findAnnotation(StandardNames.FqNames.extensionFunctionType) != null;
    }
    ...
    public static final int contextFunctionTypeParamsCount(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor mo1901findAnnotation = kotlinType.getAnnotations().mo1901findAnnotation(StandardNames.FqNames.contextFunctionTypeParams);
        if (mo1901findAnnotation == null) {
            return 0;
        }
        ConstantValue constantValue = (ConstantValue) MapsKt.getValue(mo1901findAnnotation.getAllValueArguments(), StandardNames.CONTEXT_FUNCTION_TYPE_PARAMETER_COUNT_NAME);
    ...
    public static final Name extractParameterNameFromFunctionTypeArgument(KotlinType kotlinType) {
        String value;
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor mo1901findAnnotation = kotlinType.getAnnotations().mo1901findAnnotation(StandardNames.FqNames.parameterName);
        if (mo1901findAnnotation == null) {
            return null;
        }
