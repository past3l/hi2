...
public final class TypeDeserializer {
    ...
    public final SimpleType simpleType(final ProtoBuf.Type proto, boolean z) {
        ...
        if (ErrorUtils.isError(typeConstructor.mo1906getDeclarationDescriptor())) {
        ...
        if (z && (mo1906getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
            KotlinTypeFactory kotlinTypeFactory = KotlinTypeFactory.INSTANCE;
            SimpleType computeExpandedType = KotlinTypeFactory.computeExpandedType((TypeAliasDescriptor) mo1906getDeclarationDescriptor, list);
    ...
    */
    private final kotlin.reflect.jvm.internal.impl.types.SimpleType transformRuntimeFunctionTypeToSuspendFunction(kotlin.reflect.jvm.internal.impl.types.KotlinType r6) {
        ...
        L15:
            ...
            kotlin.reflect.jvm.internal.impl.descriptors.ClassifierDescriptor r2 = r2.mo1906getDeclarationDescriptor()
            if (r2 == 0) goto L26
