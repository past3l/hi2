...
public final class LazyJavaClassDescriptor extends ClassDescriptorBase implements JavaClassDescriptor {
    ...
    public Collection<ClassDescriptor> getSealedSubclasses() {
        if (this.modality == Modality.SEALED) {
            ...
            while (it.hasNext()) {
                ClassifierDescriptor mo1906getDeclarationDescriptor = this.c.getTypeResolver().transformJavaType((JavaClassifierType) it.next(), attributes$default).getConstructor().mo1906getDeclarationDescriptor();
    ...
    public final class LazyJavaClassTypeConstructor extends AbstractClassTypeConstructor {
        ...
        public Collection<KotlinType> computeSupertypes() {
            ...
            while (true) {
                ...
                if (enhanceSuperType.getConstructor().mo1906getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor) {
                    arrayList2.add(next);
                }
            ...
            if (!arrayList2.isEmpty()) {
                ...
                ClassDescriptor mo1906getDeclarationDescriptor = mo1906getDeclarationDescriptor();
                ...
                errorReporter.reportIncompleteHierarchy(mo1906getDeclarationDescriptor, arrayList5);
            }
        ...
        private final FqName getPurelyImplementsFqNameFromAnnotation() {
            ...
            AnnotationDescriptor mo1901findAnnotation = annotations.mo1901findAnnotation(PURELY_IMPLEMENTS_ANNOTATION);
            if (mo1901findAnnotation == null) {
                return null;
            }
            Object singleOrNull = CollectionsKt.singleOrNull(mo1901findAnnotation.getAllValueArguments().values());
        ...
        public ClassDescriptor mo1906getDeclarationDescriptor() {
