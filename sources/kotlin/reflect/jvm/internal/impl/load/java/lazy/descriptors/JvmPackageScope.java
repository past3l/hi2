...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo1908getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassDescriptor mo1908getContributedClassifier = this.javaScope.mo1908getContributedClassifier(name, location);
        if (mo1908getContributedClassifier != null) {
            return mo1908getContributedClassifier;
        }
        ClassifierDescriptor classifierDescriptor = null;
        for (MemberScope memberScope : getKotlinScopes()) {
            ClassifierDescriptor contributedClassifier = memberScope.mo1908getContributedClassifier(name, location);
