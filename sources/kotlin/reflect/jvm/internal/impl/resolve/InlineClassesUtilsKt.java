...
public final class InlineClassesUtilsKt {
    ...
    public static final boolean isInlineClassType(KotlinType kotlinType) {
        ...
        if (mo1906getDeclarationDescriptor != null) {
            return isInlineClass(mo1906getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean isValueClassType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo1906getDeclarationDescriptor = kotlinType.getConstructor().mo1906getDeclarationDescriptor();
        if (mo1906getDeclarationDescriptor != null) {
            return isValueClass(mo1906getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean needsMfvcFlattening(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor mo1906getDeclarationDescriptor = kotlinType.getConstructor().mo1906getDeclarationDescriptor();
        return (mo1906getDeclarationDescriptor == null || !isMultiFieldValueClass(mo1906getDeclarationDescriptor) || SimpleClassicTypeSystemContext.INSTANCE.isNullableType(kotlinType)) ? false : true;
    }
