    ...
    public static final TypeSubstitution wrapWithCapturingSubstitution(final TypeSubstitution typeSubstitution, final boolean z) {
        ...
        return new DelegatedTypeSubstitution(typeSubstitution) { // from class: kotlin.reflect.jvm.internal.impl.resolve.calls.inference.CapturedTypeConstructorKt$wrapWithCapturingSubstitution$2
            ...
            public TypeProjection mo1911get(KotlinType key) {
                ...
                TypeProjection mo1911get = super.mo1911get(key);
                if (mo1911get == null) {
                    return null;
                }
                ClassifierDescriptor mo1906getDeclarationDescriptor = key.getConstructor().mo1906getDeclarationDescriptor();
                createCapturedIfNeeded = CapturedTypeConstructorKt.createCapturedIfNeeded(mo1911get, mo1906getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) mo1906getDeclarationDescriptor : null);
