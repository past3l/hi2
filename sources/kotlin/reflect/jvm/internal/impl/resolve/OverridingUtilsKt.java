        ...
        while (true) {
            ...
            if (!linkedList2.isEmpty()) {
                ...
                if (extractMembersOverridableInBothWays.size() == 1 && create2.isEmpty()) {
                    ...
                    Intrinsics.checkNotNullExpressionValue(boolVar, "selectMostSpecificMember(...)");
                    CallableDescriptor invoke = descriptorByHandle.invoke(boolVar);
                    for (R.bool boolVar2 : extractMembersOverridableInBothWays) {
                        Intrinsics.checkNotNull(boolVar2);
                        if (!OverridingUtil.isMoreSpecific(invoke, descriptorByHandle.invoke(boolVar2))) {
