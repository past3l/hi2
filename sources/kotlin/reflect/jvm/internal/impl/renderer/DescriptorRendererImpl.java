...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    */
    ...
    public String renderTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassifierDescriptor mo1906getDeclarationDescriptor = typeConstructor.mo1906getDeclarationDescriptor();
        if ((mo1906getDeclarationDescriptor instanceof TypeParameterDescriptor) || (mo1906getDeclarationDescriptor instanceof ClassDescriptor) || (mo1906getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
            return renderClassifierName(mo1906getDeclarationDescriptor);
        }
        ...
        throw new IllegalStateException(("Unexpected classifier: " + mo1906getDeclarationDescriptor.getClass()).toString());
    }
    ...
    public String renderAnnotation(AnnotationDescriptor annotation, AnnotationUseSiteTarget annotationUseSiteTarget) {
        ...
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo1906getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ClassConstructorDescriptor mo1900getUnsubstitutedPrimaryConstructor;
        ...
        if (annotationClass != null && (mo1900getUnsubstitutedPrimaryConstructor = annotationClass.mo1900getUnsubstitutedPrimaryConstructor()) != null && (valueParameters = mo1900getUnsubstitutedPrimaryConstructor.getValueParameters()) != null) {
    ...
    */
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ConstantValue<?> mo1902getCompileTimeInitializer;
        String renderConstant;
        if (!getIncludePropertyConstant() || (mo1902getCompileTimeInitializer = variableDescriptor.mo1902getCompileTimeInitializer()) == null || (renderConstant = renderConstant(mo1902getCompileTimeInitializer)) == null) {
            return;
        }
        sb.append(" = ");
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (mo1900getUnsubstitutedPrimaryConstructor = classDescriptor.mo1900getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(" ");
            renderAnnotations$default(this, sb, mo1900getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = mo1900getUnsubstitutedPrimaryConstructor.getVisibility();
            Intrinsics.checkNotNullExpressionValue(visibility2, "getVisibility(...)");
            renderVisibility(visibility2, sb);
            sb.append(renderKeyword("constructor"));
            List<ValueParameterDescriptor> valueParameters = mo1900getUnsubstitutedPrimaryConstructor.getValueParameters();
            Intrinsics.checkNotNullExpressionValue(valueParameters, "getValueParameters(...)");
            renderValueParameters(valueParameters, mo1900getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        Collection<KotlinType> mo1907getSupertypes = classDescriptor.getTypeConstructor().mo1907getSupertypes();
        Intrinsics.checkNotNullExpressionValue(mo1907getSupertypes, "getSupertypes(...)");
        if (mo1907getSupertypes.isEmpty()) {
            return;
        }
        if (mo1907getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(mo1907getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt.joinTo(mo1907getSupertypes, sb, (r14 & 2) != 0 ? ", " : ", ", (r14 & 4) != 0 ? "" : null, (r14 & 8) != 0 ? "" : null, (r14 & 16) != 0 ? -1 : 0, (r14 & 32) != 0 ? "..." : null, (r14 & 64) != 0 ? null : new Function1<KotlinType, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$renderSuperTypes$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
