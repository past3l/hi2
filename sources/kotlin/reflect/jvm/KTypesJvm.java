    ...
    public static final KClass<?> getJvmErasure(KClassifier kClassifier) {
        ...
        if (kClassifier instanceof KTypeParameter) {
            ...
            while (true) {
                ...
                ClassifierDescriptor mo1906getDeclarationDescriptor = ((KTypeImpl) kType).getType().getConstructor().mo1906getDeclarationDescriptor();
                classDescriptor = mo1906getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) mo1906getDeclarationDescriptor : null;
