...
public final class ModulePriorities {
    ...
    private static final Map<String, Integer> SUPPORTED_MODULES = MapsKt.mapOf(TuplesKt.to("expo.modules.splashscreen.SplashScreenPackage", 11), TuplesKt.to("expo.modules.updates.UpdatesPackage", 10));
