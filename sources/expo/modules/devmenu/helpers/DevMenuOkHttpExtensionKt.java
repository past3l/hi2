...
@Metadata(d1 = {"\u0000(\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a&\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0016\b\u0002\u0010\u0004\u001a\u0010\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u0006\u0018\u00010\u0005\u001a.\u0010\u0007\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\b\u001a\u00020\u00062\u0016\b\u0002\u0010\u0004\u001a\u0010\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u0006\u0018\u00010\u0005\u001a\u001a\u0010\t\u001a\u00020\n*\u00020\u00012\u0006\u0010\u000b\u001a\u00020\fH\u0086H¢\u0006\u0002\u0010\r¨\u0006\u000e"}, d2 = {"fetch", "Lokhttp3/Request;", ImagesContract.URL, "Landroid/net/Uri;", "authHeader", "Lkotlin/Pair;", "", "fetchGraphQL", SearchIntents.EXTRA_QUERY, "await", "Lokhttp3/Response;", "okHttpClient", "Lokhttp3/OkHttpClient;", "(Lokhttp3/Request;Lokhttp3/OkHttpClient;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "expo-dev-menu_release"}, k = 2, mv = {1, 9, 0}, xi = 48)
...
public final class DevMenuOkHttpExtensionKt {
    ...
    public static final Request fetchGraphQL(Uri url, String query, Pair<String, String> pair) {
        ...
        String uri = url.toString();
        Intrinsics.checkNotNullExpressionValue(uri, "toString(...)");
        Request.Builder addHeader = builder.url(uri).method(ShareTarget.METHOD_POST, RequestBody.INSTANCE.create(MediaType.INSTANCE.m2321deprecated_parse("application/json"), "{\"query\": \"" + StringsKt.replace$default(StringsKt.replace$default(StringsKt.trimIndent(query), "\n", "\\n", false, 4, (Object) null), "\"", "\\\"", false, 4, (Object) null) + "\"}")).addHeader("Content-Type", "application/json");
        if (pair != null) {
