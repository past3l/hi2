...
public final class EitherTypeConverter<FirstType, SecondType> extends NullAwareTypeConverter<Either<FirstType, SecondType>> {
    ...
    public Either<FirstType, SecondType> convertNonOptional(Object value, AppContext context) {
        ...
        return new Either<>(value, CollectionsKt.toMutableList((Collection) EitherTypeConverterKt.access$createDeferredValues(value, context, CollectionsKt.listOf((Object[]) new Pair[]{TuplesKt.to(this.firstType, this.firstTypeConverter), TuplesKt.to(this.secondType, this.secondTypeConverter)}), listOf)), listOf);
    }
