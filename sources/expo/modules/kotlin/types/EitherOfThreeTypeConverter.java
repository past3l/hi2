...
public final class EitherOfThreeTypeConverter<FirstType, SecondType, ThirdType> extends NullAwareTypeConverter<EitherOfThree<FirstType, SecondType, ThirdType>> {
    ...
    public EitherOfThree<FirstType, SecondType, ThirdType> convertNonOptional(Object value, AppContext context) {
        ...
        return new EitherOfThree<>(value, CollectionsKt.toMutableList((Collection) EitherTypeConverterKt.access$createDeferredValues(value, context, CollectionsKt.listOf((Object[]) new Pair[]{TuplesKt.to(this.firstType, this.firstTypeConverter), TuplesKt.to(this.secondType, this.secondTypeConverter), TuplesKt.to(this.thirdType, this.thirdTypeConverter)}), listOf)), listOf);
    }
