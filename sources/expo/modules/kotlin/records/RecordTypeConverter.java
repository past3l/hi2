...
public final class RecordTypeConverter<T extends Record> extends DynamicAwareTypeConverters<T> {
    ...
    public static final /* data */ class PropertyDescriptor {
        ...
        public int hashCode() {
            return (((((this.typeConverter.hashCode() * 31) + this.fieldAnnotation.hashCode()) * 31) + KeyCommand$$ExternalSyntheticBackport0.m(this.isRequired)) * 31) + this.validators.hashCode();
        }
