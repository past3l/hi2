...
public final class ActivityResultsManager implements AppContextActivityResultCaller, AppCompatActivityAware {
    ...
    @DebugMetadata(c = "expo.modules.kotlin.activityresult.ActivityResultsManager$1", f = "ActivityResultsManager.kt", i = {0}, l = {ReactStage.ON_ATTACH_TO_INSTANCE}, m = "invokeSuspend", n = {"$this$withActivityAvailable$iv"}, s = {"L$0"})
            ...
            if (i == 0) {
                ...
                final ?? r5 = new OnActivityAvailableListener() { // from class: expo.modules.kotlin.activityresult.ActivityResultsManager$1$invokeSuspend$$inlined$withActivityAvailable$1
                    ...
                    public void onActivityAvailable(AppCompatActivity activity) {
                        ...
                        cancellableContinuation.resumeWith(m604constructorimpl);
                    }
                };
        ...
        final ?? r9 = new OnActivityAvailableListener() { // from class: expo.modules.kotlin.activityresult.ActivityResultsManager$registerForActivityResult$$inlined$withActivityAvailable$1
            ...
            public void onActivityAvailable(AppCompatActivity activity) {
                ...
                try {
                    ...
                    m604constructorimpl = Result.m604constructorimpl(appContextActivityResultRegistry.register("AppContext_rq#" + atomicInteger.getAndIncrement(), activity, appContextActivityResultContract, appContextActivityResultFallbackCallback));
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    m604constructorimpl = Result.m604constructorimpl(ResultKt.createFailure(th));
                }
