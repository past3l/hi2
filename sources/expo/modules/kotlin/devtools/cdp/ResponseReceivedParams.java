...
public final /* data */ class ResponseReceivedParams implements JsonSerializable {
    ...
    public int hashCode() {
        return (((((((((this.requestId.hashCode() * 31) + this.loaderId.hashCode()) * 31) + this.timestamp.hashCode()) * 31) + this.type.hashCode()) * 31) + this.response.hashCode()) * 31) + KeyCommand$$ExternalSyntheticBackport0.m(this.hasExtraInfo);
    }
