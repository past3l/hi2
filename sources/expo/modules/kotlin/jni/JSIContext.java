...
public final class JSIContext implements Destructible {
    ...
    public final void registerSharedObject(Object r2, JavaScriptObject js) {
        ...
        SharedObjectId.m575boximpl(sharedObjectRegistry.m585add5WKnsLU$expo_modules_core_release((SharedObject) r2, js));
    }
    ...
    public final void deleteSharedObject(int id) {
        ...
        sharedObjectRegistry.m586deletekyJHjyY$expo_modules_core_release(SharedObjectId.m576constructorimpl(id));
    }
