...
public final class FloatAsyncFunctionComponent extends AsyncFunctionComponent<Float> {
    ...
    public void callUserImplementation$expo_modules_core_release(Object[] args, Promise promise, AppContext appContext) {
        ...
        promise.resolve(getBody().invoke(convertArgs(args, appContext)).floatValue());
    }
}
