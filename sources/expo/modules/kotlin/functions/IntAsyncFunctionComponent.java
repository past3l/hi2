...
public final class IntAsyncFunctionComponent extends AsyncFunctionComponent<Integer> {
    ...
    public void callUserImplementation$expo_modules_core_release(Object[] args, Promise promise, AppContext appContext) {
        ...
        promise.resolve(getBody().invoke(convertArgs(args, appContext)).intValue());
    }
}
