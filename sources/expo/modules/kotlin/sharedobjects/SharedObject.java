...
public class SharedObject {
    ...
    public final void m574setSharedObjectIdkyJHjyY$expo_modules_core_release(int i) {
        this.sharedObjectId = i;
    }

    public SharedObject(AppContext appContext) {
        this.sharedObjectId = SharedObjectId.m576constructorimpl(0);
    ...
    private final JavaScriptObject getJavaScriptObject() {
        int m576constructorimpl = SharedObjectId.m576constructorimpl(this.sharedObjectId);
        AppContext appContext = getAppContext();
        if (appContext == null) {
            return null;
        }
        return SharedObjectId.m580toJavaScriptObjectimpl(m576constructorimpl, appContext);
    }
