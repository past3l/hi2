...
public interface DevMenuExtensionInterface {
    ...
    public static final class DefaultImpls {
        public static List<DevMenuDataSourceInterface> devMenuDataSources(DevMenuExtensionInterface devMenuExtensionInterface, DevMenuExtensionSettingsInterface settings) {
            Intrinsics.checkNotNullParameter(settings, "settings");
            return null;
        }

        public static List<DevMenuScreen> devMenuScreens(DevMenuExtensionInterface devMenuExtensionInterface, DevMenuExtensionSettingsInterface settings) {
            Intrinsics.checkNotNullParameter(settings, "settings");
            return null;
        }
    }

    List<DevMenuDataSourceInterface> devMenuDataSources(DevMenuExtensionSettingsInterface settings);

    DevMenuItemsContainerInterface devMenuItems(DevMenuExtensionSettingsInterface settings);

    List<DevMenuScreen> devMenuScreens(DevMenuExtensionSettingsInterface settings);
