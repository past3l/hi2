...
public final class MinElf {
    ...
    private static String[] extract_DT_NEEDED_no_retries(ElfByteChannel elfByteChannel) throws IOException {
        ...
        long j13 = z ? getu32(elfByteChannel, allocate, 28L) : get64(elfByteChannel, allocate, 32L);
        long j14 = z ? getu16(elfByteChannel, allocate, 44L) : getu16(elfByteChannel, allocate, 56L);
        int i = getu16(elfByteChannel, allocate, z ? 42L : 54L);
        if (j14 == WebSocketProtocol.PAYLOAD_SHORT_MAX) {
            long j15 = z ? getu32(elfByteChannel, allocate, 32L) : get64(elfByteChannel, allocate, 40L);
            if (z) {
                j14 = getu32(elfByteChannel, allocate, j15 + 28);
            } else {
                j14 = getu32(elfByteChannel, allocate, j15 + 44);
            }
        }
        long j16 = j13;
        long j17 = 0;
        while (true) {
            ...
            if (z) {
                j11 = getu32(elfByteChannel, allocate, j16);
            } else {
                j11 = getu32(elfByteChannel, allocate, j16);
            }
            if (j11 != 2) {
                ...
                j = getu32(elfByteChannel, allocate, j16 + 4);
            } else {
                j = get64(elfByteChannel, allocate, j16 + 8);
            }
        }
        if (j == 0) {
        ...
        long j19 = 0;
        do {
            j2 = z ? getu32(elfByteChannel, allocate, j18) : get64(elfByteChannel, allocate, j18);
            if (j2 == 1) {
                ...
                str = "malformed DT_NEEDED section";
                j19 = z ? getu32(elfByteChannel, allocate, j18 + 4) : get64(elfByteChannel, allocate, j18 + 8);
            } else {
                str = "malformed DT_NEEDED section";
            }
            j18 += z ? 8L : 16L;
        ...
        while (true) {
            ...
            if (z) {
                j6 = getu32(elfByteChannel, allocate, j20);
            } else {
                j6 = getu32(elfByteChannel, allocate, j20);
            }
            if (j6 == 1) {
                if (z) {
                    j7 = j14;
                    j8 = getu32(elfByteChannel, allocate, j20 + 8);
                } else {
                    j7 = j14;
                    j8 = get64(elfByteChannel, allocate, j20 + 16);
                }
                if (z) {
                    j3 = j;
                    j9 = getu32(elfByteChannel, allocate, j20 + 20);
                } else {
                    j3 = j;
                    j9 = get64(elfByteChannel, allocate, j20 + 40);
                }
                if (j8 <= j19 && j19 < j9 + j8) {
                    if (z) {
                        j10 = getu32(elfByteChannel, allocate, j20 + 4);
                    } else {
                        j10 = get64(elfByteChannel, allocate, j20 + 8);
                    }
                    j5 = j10 + (j19 - j8);
                    j4 = 0;
                }
        ...
        while (true) {
            ...
            if (j22 == 1) {
                strArr[i4] = getSz(elfByteChannel, allocate, (z ? getu32(elfByteChannel, allocate, j21 + 4) : get64(elfByteChannel, allocate, j21 + 8)) + j5);
