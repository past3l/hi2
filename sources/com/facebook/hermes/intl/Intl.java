...
public class Intl {
    ...
    public static String toLocaleLowerCase(List<String> list, String str) throws JSRangeErrorException {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            lowerCase = UCharacter.toLowerCase(Intl$$ExternalSyntheticApiModelOutline0.m152m(LocaleMatcher.bestFitMatch((String[]) list.toArray(strArr)).matchedLocale.getLocale()), str);
            return lowerCase;
        }
    ...
    public static String toLocaleUpperCase(List<String> list, String str) throws JSRangeErrorException {
        ...
        String[] strArr = new String[list.size()];
        if (Build.VERSION.SDK_INT >= 24) {
            upperCase = UCharacter.toUpperCase(Intl$$ExternalSyntheticApiModelOutline0.m152m(LocaleMatcher.bestFitMatch((String[]) list.toArray(strArr)).matchedLocale.getLocale()), str);
            return upperCase;
        }
