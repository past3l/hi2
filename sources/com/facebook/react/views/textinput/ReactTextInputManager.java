...
public class ReactTextInputManager extends BaseViewManager<ReactEditText, LayoutShadowNode> {
    ...
    public Map<String, Object> getExportedCustomBubblingEventTypeConstants() {
        ...
        exportedCustomBubblingEventTypeConstants.putAll(MapBuilder.builder().put("topSubmitEditing", MapBuilder.of("phasedRegistrationNames", MapBuilder.of("bubbled", "onSubmitEditing", "captured", "onSubmitEditingCapture"))).put("topEndEditing", MapBuilder.of("phasedRegistrationNames", MapBuilder.of("bubbled", "onEndEditing", "captured", "onEndEditingCapture"))).put("topTextInput", MapBuilder.of("phasedRegistrationNames", MapBuilder.of("bubbled", "onTextInput", "captured", "onTextInputCapture"))).put(SearchBarFocusEvent.EVENT_NAME, MapBuilder.of("phasedRegistrationNames", MapBuilder.of("bubbled", "onFocus", "captured", "onFocusCapture"))).put(SearchBarBlurEvent.EVENT_NAME, MapBuilder.of("phasedRegistrationNames", MapBuilder.of("bubbled", "onBlur", "captured", "onBlurCapture"))).put(ReactTextInputKeyPressEvent.EVENT_NAME, MapBuilder.of("phasedRegistrationNames", MapBuilder.of("bubbled", "onKeyPress", "captured", "onKeyPressCapture"))).build());
    ...
    public void setSelectionHandleColor(ReactEditText reactEditText, Integer num) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (num != null) {
                LinkFollowing$$ExternalSyntheticApiModelOutline0.m1830m();
                int intValue = num.intValue();
                blendMode = BlendMode.SRC_IN;
                BlendModeColorFilter m = LinkFollowing$$ExternalSyntheticApiModelOutline0.m(intValue, blendMode);
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (textCursorDrawable != null) {
                if (num != null) {
                    ...
                    int intValue = num.intValue();
                    blendMode = BlendMode.SRC_IN;
                    textCursorDrawable.setColorFilter(LinkFollowing$$ExternalSyntheticApiModelOutline0.m(intValue, blendMode));
                } else {
