...
public class SurfaceHandlerBinding implements SurfaceHandler {
    ...
    public void setLayoutConstraints(int i, int i2, int i3, int i4, boolean z, boolean z2, float f) {
        setLayoutConstraintsNative(LayoutMetricsConversions.CC.getMinSize(i) / f, LayoutMetricsConversions.CC.getMaxSize(i) / f, LayoutMetricsConversions.CC.getMinSize(i2) / f, LayoutMetricsConversions.CC.getMaxSize(i2) / f, i3 / f, i4 / f, z, z2, f);
    }
