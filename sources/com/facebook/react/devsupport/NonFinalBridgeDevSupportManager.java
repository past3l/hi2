...
public class NonFinalBridgeDevSupportManager extends DevSupportManagerBase {
    ...
    public NonFinalBridgeDevSupportManager(Context context, ReactInstanceDevHelper reactInstanceDevHelper, String str, boolean z, RedBoxHandler redBoxHandler, DevBundleDownloadListener devBundleDownloadListener, int i, Map<String, RequestHandler> map, SurfaceDelegateFactory surfaceDelegateFactory, DevLoadingViewManager devLoadingViewManager) {
        ...
        addCustomDevOption(context.getString(R.string.catalyst_sample_profiler_toggle), new DevOptionHandler() { // from class: com.facebook.react.devsupport.NonFinalBridgeDevSupportManager.1
            @Override // com.facebook.react.devsupport.interfaces.DevOptionHandler
            public void onOptionSelected() {
                NonFinalBridgeDevSupportManager.this.toggleJSSamplingProfiler();
            }
        });
    }
    ...
    public void loadSplitBundleFromServer(final String str, final DevSplitBundleCallback devSplitBundleCallback) {
        fetchSplitBundleAndCreateBundleLoader(str, new DevSupportManagerBase.CallbackWithBundleLoader() { // from class: com.facebook.react.devsupport.NonFinalBridgeDevSupportManager.2
            ...
            public void onSuccess(JSBundleLoader jSBundleLoader) {
                jSBundleLoader.loadScript(NonFinalBridgeDevSupportManager.this.getCurrentContext().getCatalystInstance());
                ((HMRClient) NonFinalBridgeDevSupportManager.this.getCurrentContext().getJSModule(HMRClient.class)).registerBundle(NonFinalBridgeDevSupportManager.this.getDevServerHelper().getDevServerSplitBundleURL(str));
    ...
    public WebsocketJavaScriptExecutor.JSExecutorConnectCallback getExecutorConnectCallback(final SimpleSettableFuture<Boolean> simpleSettableFuture) {
        return new WebsocketJavaScriptExecutor.JSExecutorConnectCallback() { // from class: com.facebook.react.devsupport.NonFinalBridgeDevSupportManager.3
            @Override // com.facebook.react.devsupport.WebsocketJavaScriptExecutor.JSExecutorConnectCallback
            public void onSuccess() {
                simpleSettableFuture.set(true);
                NonFinalBridgeDevSupportManager.this.hideDevLoadingView();
            }
            ...
            public void onFailure(Throwable th) {
                ...
                simpleSettableFuture.setException(new IOException(NonFinalBridgeDevSupportManager.this.getApplicationContext().getString(R.string.catalyst_debug_error), th));
            }
        };
    }
    ...
    private void reloadJSInProxyMode() {
        ...
        getReactInstanceDevHelper().onReloadWithJSDebugger(new JavaJSExecutor.Factory() { // from class: com.facebook.react.devsupport.NonFinalBridgeDevSupportManager.4
            @Override // com.facebook.react.bridge.JavaJSExecutor.Factory
            public JavaJSExecutor create() throws Exception {
                WebsocketJavaScriptExecutor websocketJavaScriptExecutor = new WebsocketJavaScriptExecutor();
                SimpleSettableFuture simpleSettableFuture = new SimpleSettableFuture();
                websocketJavaScriptExecutor.connect(NonFinalBridgeDevSupportManager.this.getDevServerHelper().getWebsocketProxyURL(), NonFinalBridgeDevSupportManager.this.getExecutorConnectCallback(simpleSettableFuture));
                try {
