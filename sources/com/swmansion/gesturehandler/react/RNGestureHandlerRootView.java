...
public final class RNGestureHandlerRootView extends ReactViewGroup {
    ...
    public void onAttachedToWindow() {
        ...
        boolean z = !INSTANCE.hasGestureHandlerEnabledRootView(rNGestureHandlerRootView);
        this._enabled = z;
        if (!z) {
