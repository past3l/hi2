...
final class zza extends AsyncTask<Void, Void, Integer> {
    ...
    protected final /* synthetic */ void onPostExecute(Integer num) {
        ...
        this.zzix.onProviderInstallFailed(num2.intValue(), googleApiAvailabilityLight.getErrorResolutionIntent(this.val$context, num2.intValue(), ContextChain.TAG_PRODUCT_AND_INFRA));
    }
}
